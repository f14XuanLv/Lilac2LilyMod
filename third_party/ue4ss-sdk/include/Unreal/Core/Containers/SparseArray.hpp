...
#include <Unreal/Core/Templates/UnrealTypeTraits.hpp>
...
#include <Unreal/Core/Templates/Less.hpp>
#include <Unreal/Core/Containers/Array.hpp>
#include <Unreal/Core/Math/UnrealMathUtility.hpp>
#include <Unreal/Core/Containers/ScriptArray.hpp>
#include <Unreal/Core/Containers/BitArray.hpp>
...
template <typename T, typename Allocator> void* operator new(size_t Size, RC::Unreal::TSparseArray<T, Allocator>& Array);
template <typename T, typename Allocator> void* operator new(size_t Size, RC::Unreal::TSparseArray<T, Allocator>& Array, RC::Unreal::int32 Index);
inline void* operator new(size_t Size, const RC::Unreal::FSparseArrayAllocationInfo& Allocation);
...
{
    check( Size == sizeof( T ) );
    const RC::Unreal::int32 Index = Array.AddUninitialized().Index;
    return &Array[ Index ];
}
template <typename T, typename Allocator> void* operator new( size_t Size, RC::Unreal::TSparseArray<T, Allocator>& Array, RC::Unreal::int32 Index )
{
