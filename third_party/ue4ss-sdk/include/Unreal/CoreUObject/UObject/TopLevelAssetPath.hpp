...
#include "Containers/StringFwd.hpp"
#include "Containers/UnrealString.hpp"
#include "Containers/FString.hpp"
#include "Containers/StringView.hpp"
#include "CoreTypes.hpp"
#include "FArchive.hpp"
#include "Serialization/StructuredArchive.hpp"
#include "Templates/TypeHash.hpp"
...
namespace RC::Unreal
{
    ...
    */
    struct FTopLevelAssetPath
    {
        ...
        bool TrySetPath(const StringType& InPath) 
        {
            // Convert StringType to FString and delegate
            FString temp(InPath.c_str());
            return TrySetPath(temp);
        }
        ...
        UE_DEPRECATED(5.1, "FNames containing full asset paths have been replaced by FTopLevelAssetPath/FSoftLevelObjectPath."
            ...
            "Those APIS should be updated to use FTopLevelAssetPath or FSoftLevelObjectPath.")
        FName ToFName() const { return FName(*ToString()); }
