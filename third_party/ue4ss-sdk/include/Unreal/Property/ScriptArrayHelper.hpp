...
/*=============================================================================
    ScriptArrayHelper.hpp: Forwarding include for backward compatibility
...
#pragma message("ScriptArrayHelper.hpp is now a forwarding include. Please use <Unreal/CoreUObject/UObject/UnrealType.hpp> instead.")
#endif
